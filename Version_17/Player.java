...
public class Player extends Actor{
	...
	protected void updateSpeed() {
		...
		this.vx=0; this.vy=0;
		if(this.down) this.vy = this.PLAYER_SPEED;
		if(this.up) this.vy = -this.PLAYER_SPEED;
		if(this.left) this.vx = -this.PLAYER_SPEED;
		if(this.right) this.vx = this.PLAYER_SPEED;
